...
export default function CartItem({ item, isSelected, onSelectChange }: CartItemProps) {
    ...
    return (
        <li className="flex items-start gap-3 py-4 px-4 hover:bg-gray-50/50 transition-colors">
            {/* Checkbox */}
            <div className="flex items-center pt-1">
                <input
                    ...
                    className="h-5 w-5 rounded-md border-gray-300 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer transition-all"
                />
            </div>
                ...
                <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex items-center rounded-xl border border-gray-200 bg-white shadow-sm">
                        ...
                        <button
                            type="button"
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                            className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-r-xl transition-colors"
                        >
